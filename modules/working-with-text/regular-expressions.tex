...
filenames = glob("/home/articles/*.txt")
results = []
...
for filepath in filenames:
   with open(filepath, encoding="utf-8") as f:
      ...
      israel_mentions = len(re.findall(
         r'Israel.*?(minister|politician|authority)', text, re.IGNORECASE))
      palestine_mentions = len(re.findall(r'palest', text, re.IGNORECASE))
...
with open("results.csv", mode="w", encoding="utf-8", newline='') as f_out:
   writer = csv.writer(f_out)
   writer.writerow(["filename", "israel_mentions", "palestine_mentions"])
