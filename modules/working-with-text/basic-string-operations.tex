...
\begin{minted}{python}
# In reality you'd read this from a file...
data = [
    "I <b>really</b> liked this movie! It was great.  ",
    "  What an awful movie",
    "Awesome!!!"
]
# Step-by-step cleaning
data_stripped = [e.strip() for e in data]                # remove spaces
data_lower    = [e.lower() for e in data_stripped]       # lowercase
data_clean    = [e.replace("<b>", "").replace("</b>", "") 
                 for e in data_lower]                    # remove simple HTML

# Or all in one step:
data_clean2 = [e.strip().lower()
                  .replace("<b>", "").replace("</b>", "")
                for e in data]
\end{minted}
\end{frame}
...
# a punctuation sign. Then, we join the elements of the list directly
...
data_clean3 = [
    strip_punctuation(e).strip().lower()
    .replace("<b>", "").replace("</b>", "")
    for e in data
]
\end{minted}    
