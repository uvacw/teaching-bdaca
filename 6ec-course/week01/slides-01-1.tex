...
\begin{frame}{Anne}
	...
	\begin{columns}
		...
		\column{.7\textwidth}
		dr. Anne Kroon \\
		Associate Professor Communication, Organizations, and Society \\
		\begin{itemize}
		...
		\end{itemize}
		 ~~ a.c.kroon@uva.nl ~~ REC-C~7\textsuperscript{th}~floor 
	\end{columns}
\end{frame}
...
\begin{frame}{You}
	\begin{columns}
		...
		Your name?\\
		Your background?\\
		Even though this course is now mandatory, what do you *hope* to get out of it?
	\end{columns}
\end{frame}
