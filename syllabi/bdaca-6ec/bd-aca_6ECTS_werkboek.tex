...
Nevertheless, \url{https://google.com} and \url{https://stackoverflow.com} should be your first points of contact. After all, that's how we solve our problems as well\ldots

It is also very much encouraged to try to solve problems together with your classmates. A successful technique can be \emph{pair programming}, where two colleagues sit behind one screen (for an explanation, see \url{https://en.wikipedia.org/wiki/Pair_programming}).
...
We encourage you to develop your own analytical and research skills throughout this course.

\begin{itemize}
	\item Do not use AI tools to generate, write, or substantially complete any assignments or projects that you submit for assessment. Doing so will be treated as academic misconduct.
	\item You may use AI tools responsibly to clarify concepts, review methodologies, or help debug analyses that you have conducted yourself. The final work you submit must be authored by you and fully understood by you.
	...
	\item If you use AI, disclose and cite the tool and briefly describe how you used it. Normal plagiarism and fraud rules apply.
\end{itemize}
