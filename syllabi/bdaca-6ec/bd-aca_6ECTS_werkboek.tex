...
During the Thursday lab sessions, collaboration and mutual support are strongly encouraged. Students are encouraged to discuss programming concepts, compare approaches, ask questions, and help one another work through exercises. This collaboration is intended to support learning and does not permit students to share or jointly produce assessed code, analyses, or written project material.

During the Week 7 project workshop, students are encouraged to discuss project plans and provide constructive feedback to peers. This peer feedback is formative and is not graded. Receiving or giving feedback does not permit students to share or jointly produce assessed code, analyses, or written project material.
